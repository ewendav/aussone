...
Class metierAdherent
	...
	public function __get($attribut)
		{	switch ($attribut)
			{	case 'idAdherent' :
					return $this->idAdherent; break;
				case 'nomAdherent' : 
					return $this->nomAdherent; break;
				case 'prenomAdherent' :
					return $this->prenomAdherent; break;
				case 'ageAdherent' :
					return $this->ageAdherent; break;
				case 'sexeAdherent' :
					return $this->sexeAdherent; break;
				case 'loginAdherent' :
					return $this->loginAdherent; break;
				case 'pwdAdherent' :
					return $this->pwdAdherent; break;
				case 'idEquipe' :
					return $this->lEquipe->idEquipe; break;
				case 'nomEquipe' :
						return $this->lEquipe->nomEquipe; break;
				default :
...
{	switch($attribut)
	{	case 'idAdherent' :
			$this->idAdherent=$laValeurDeLAttribut; break;
		case 'nomAdherent' : 
			$this->nomAdherent=$laValeurDeLAttribut; break;
		case 'prenomAdherent' :
			$this->prenomAdherent=$laValeurDeLAttribut; break;
		case 'ageAdherent' :
			$this->ageAdherent=$laValeurDeLAttribut; break;
		case 'loginAdherent' :
			$this->loginAdherent=$laValeurDeLAttribut; break;
		case 'pwdAdherent' :
			$this->pwdAdherent=$laValeurDeLAttribut; break;
		case 'idEquipe' :
			$this->lEquipe->idEquipe=$laValeurDeLAttribut; break;
		case 'nomEquipe' :
				$this->lEquipe->nomEquipe=$laValeurDeLAttribut; break;
		default :
			$trace = debug_backtrace();
			trigger_error('Propriété non-accessible via _get() :'.$attribut.'dans '.$trace[0]['file'].' à la ligne'.$trace[0]['line'],E_USER_NOTICE);
			break;
